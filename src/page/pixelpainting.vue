<template>
  <div class="hello">
    ...
    <div class="container-inner" >
        ...
        <div class="sections">
          <h4 class="case_title">{{customized.pixelpainting_title}}</h4>
          <div class="case_box">
            <div class="row_box">
              <router-link :to="'/case?itme=' + index" v-for="(item, index) in customized.pixelpainting_case" :key="index" class="case_info d-flex align-items-center">
                <img :src="'../../static/images/case/icon' + index + '.jpg'" />
                <dl class="mask">{{item}}</dl>
              </router-link>
            </div>
          </div>
          <router-link class="case_btn" to="/sculpture">{{customized.sculpture_title}}</router-link>
        </div>
    </div>
